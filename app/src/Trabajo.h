...
/// @param tamSer recibe el tama�o del array de la estructura eServicio
...
/// @param tamTra recibe el tama�o del array de la estructura eTrabajo
/// @param notebooks recibe el array de la estructura eNotebook
/// @param tamNot recibe el tama�o del array de la estructura eNotebook
/// @param servicios recibe el array de la estructura eServicio
/// @param tamSer recibe el tama�o del array de la estructura eServicio
...
///
/// @param vec recibe el array de la estructura eTrabajo
/// @param tam recibe el tama�o del array de la estructura eTrabajo
/// @return devuelve 1 si funciono correctamente, y sino devuelve 0
...
/// @brief Le cargo datos v�lidos de distintos trabajos para ya tener
...
/// @brief Muestra un listado de los trabajos que est�n vinculados a una
