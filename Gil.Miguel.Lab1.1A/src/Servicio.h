...
/// @brief Muestra un listado de todas las Notebooks del sistema, con su ID y descripción.
///
/// @param servicios recibe el array de la estructura eServicio
/// @param tam recibe el tamaño del array de la estructura eServicio
/// @return devuelve 1 si funciono correctamente, y sino devuelve 0
int listarServicios(eServicio servicios[], int tam);


/// @brief Le pasa el valor de descripción de la estructura eServicio a un array también
...
/// @brief Busca por ID el servicio que se solicite, y le da valor al índice correspondiente (o -1).
///
/// @param servicios recibe el array de la estructura eServicio
/// @param tam recibe el tamaño del array de la estructura eServicio
