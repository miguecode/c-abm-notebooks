...
/// @brief Muestra un listado de todos los tipos del sistema, con su ID y descripción.
///
/// @param tipos recibe el array de la estructura eTipo
/// @param tam recibe el tamaño del array de la estructura eTipo
/// @return devuelve 1 si funciono correctamente, y sino devuelve 0
int listarTipos(eTipo tipos[], int tam);


/// @brief Le pasa el valor de descripción de la estructura eTipo a un array también
...
/// @brief Busca por ID el tipo que se solicite, y le da valor al índice correspondiente (o -1).
///
/// @param tipos recibe el array de la estructura eTipo
/// @param tam recibe el tamaño del array de la estructura eTipo
